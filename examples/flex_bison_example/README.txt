...
To create the executable 'calc', just use 'make'.

To use it, type './calc -l <source_file>' to only do the lexical analysis or
type './calc <source_file>' or './calc -p <source_file>' to also do the syntax
analysis and to compute the result.

Some small example files are provided in the 'examples' folder.
