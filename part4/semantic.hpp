...
namespace VSOP
{
    ...
    public:
        ...
        /**
         * @brief Get the classes map for code generation
         *
         * @return const std::map<std::string, ClassInfo>& Map of class names to class info
         */
        const std::map<std::string, ClassInfo> &getClasses() const { return classes; }
